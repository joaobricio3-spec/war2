...
- `card-joker.png` — emblema de coringa de carta em latão, arte original gerada por IA
- `die-red.png` — face de dado vermelha sem pips, arte original gerada por IA
- `die-ivory.png` — face de dado marfim sem pips, arte original gerada por IA
- `logo.png` — logotipo WAR2, arte original gerada por IA
